...
class MenuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Backend.menu.select',compact('menus','kategoris'));
    ...
    {
        $kategoris = Kategori::all();
        return view('Backend.menu.insert', compact('kategoris'));
    }
        ...
        public function edit($idmenu)
    {
        ...
        return view('Backend.menu.update',compact('menu','kategoris'));
    }
